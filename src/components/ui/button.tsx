...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:-translate-y-0.5 font-semibold active:translate-y-0",
        ...
        hero: "bg-primary text-primary-foreground hover:bg-primary/90 font-bold text-base tracking-wider shadow-lg hover:shadow-xl transition-all duration-300 rounded-sm font-display hover:-translate-y-1 active:translate-y-0",
        bid: "bg-primary text-primary-foreground hover:bg-primary/90 font-bold uppercase tracking-wider hover:-translate-y-0.5 active:translate-y-0",
      },
      size: {
